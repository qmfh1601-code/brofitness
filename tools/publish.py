...
PRICING_FAQ = [
    ("청주 헬스장 가격은 얼마인가요?",
     "브로피트니스 기준 한 달 34,900원부터입니다. 용암점과 금천점이 월 34,900원, 복대점이 월 38,900원이며 약정과 위약금이 없습니다. 이 금액에 샤워실 이용이 포함되며, 락커와 운동복 대여는 별도 비용입니다."),
    ("헬스장 한 달만 등록할 수 있나요?",
    ...
    ("헬스장 등록할 때 운동복이나 수건을 챙겨가야 하나요?",
     "운동복과 수건은 직접 챙겨 오시는 것을 권장합니다. 현장에도 운동복·락커 대여가 있지만 별도 비용이며, 샤워실 이용만 구독 요금에 포함됩니다."),
    ("헬스장 지점마다 요금이 다른가요?",
